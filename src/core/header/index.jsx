    ...
    <div className={`header ${chooseBackgroundClass()}`}>
      <div className={`header__container`}>
        ...
        {!isMobile ? (
          <Link to="/">
            {location.pathname === "/" ? (
              ...
              <IconLogoDark className="header__logo" />
            )}
          </Link>
        ) : null}
        {!isMobile ? (
          <nav className="header-nav">
            ...
            <span className="header-nav__link">
              <Link onClick={() => scrollTo("scada")} to="/#scada">
                Диспетчеризация
              </Link>
            </span>
            <span className="header-nav__link">
              <Link onClick={() => scrollTo("toir")} to="/#toir">
                ТОиР
              </Link>
            </span>
            <span className="header-nav__link">
              <Link onClick={() => scrollTo("integration")} to="/#integration">
                Интеграция
              </Link>
            </span>
            <span className="header-nav__link">
              <Link onClick={() => scrollTo("control")} to="/#control">
                Контроль
              </Link>
            </span>
            <span className="header-nav__link">
              <Link onClick={() => scrollTo("news")} to="/#news">
                Новости
              </Link>
            </span>
          </nav>
        ...
        <div className="header__signin">
          ...
          {!isMobile ? (
            <span className="header-nav__connect" onClick={openPopup}>
              Связаться с нами
            </span>
          ) : null}
        </div>
