...
const MODULES = [
    {
        ...
        basic: [{
            optionName: 'модуль_1',
            options: ['Универсальный интегратор SCADA систем (MB RTU, TCP, S7, Profinet и др.)',
...
},
    {
        ...
        basic: [{
            optionName: 'модуль_2',
            options: ['Менеджер бизнес-процессов. Индивидуальная настройка Объектов / Устройств / Пользователей',
    ...
    },
    {
        ...
        basic: [{
            optionName: 'модуль_3',
            options: ['Автоматизированные мобильные рабочие места исполнителей',
    ...
    },
    {
        ...
        basic: [{
            ...
            options: ['Расширение функционала дополнительными модулями и сервисами'],
            cost: 'Рассчитывается индивидуально'
        }],
        additional: [{
            optionName: 'модуль_4_модуль_интеграции_3D',
            options: ['Модуль интеграции 3D BIM моделей. Построение 3-х мерных интерактивных карт'],
            cost: 'Рассчитывается индивидуально', 
        },
        {
        ...
        },
        {
            ...
            options: ['Модуль интеграции с системами электронного документооборота 1:С'],
            cost: 'Рассчитывается индивидуально', 
        },
        {
            optionName: 'модуль_4_CCTV',
            options: ['CCTV Промышленная видеоаналитика, определение аварийных ситуаций'],
            cost: 'Рассчитывается индивидуально', 
        },
    ],
    }
...
const Form = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        модуль_4_расширение_функционала: false,
        модуль_4_модуль_интеграции_3D: false,
        модуль_4_построение_гибких_бизнес_процессов: false,
        модуль_4_системы_электронного_документооборота: false,
        модуль_4_модуль_статистической_аналитики: false,
        модуль_4_модуль_интеграции_1C: false,
        модуль_4_CCTV: false,
    });
                    ...
                    <div className='request-form__main'>
                        ...
                        <div className='request-form__block'>
                            ...
                            <div className='request-form__block-title'>Настройка модулей</div>
                                ...
                                { MODULES.map((module) => (<div className='grid__row'>
                                    <div className='grid__item grid__item-name'>{ module.name }</div>
                                        <div className='grid__item'>
                                            { module.additional && module.additional?.length > 0 ? <div className='grid__item grid__item-header'>Базовый состав модуля</div> :
                                                <div className='grid__item grid__item-header'>Состав модуля</div>
                                            }
                                                ...
                                                module.basic.map((basic) => (
                                                    <div className='grid__item-inner-container'>
                                                        ...
                                                        <div className='grid__item-inner'>
                                                            <input type="checkbox" id={basic.optionName} name={basic.optionName} checked={formData[basic.optionName]} value={formData[basic.optionName]} onChange={handleChange} />
                                                        </div>
                                                    </div>
                                                ))
                                            }

                                            { module.additional && module.additional.length > 0 ? <div className='grid__item grid__item-header'>Дополнительные подмодули</div> :
                                                null
                                            }

                                            {
                                                module.additional?.map((additional) => (
                                                    <div className='grid__item-inner-container'>
                                                        ...
                                                        <div className='grid__item-inner'>
                                                            <input type="checkbox" id={additional.optionName} name={additional.optionName} checked={formData[additional.optionName]} value={formData[additional.optionName]} onChange={handleChange} />
                                                        </div>
                                                    </div>
                                                ))
                                            }
                        ...
                        <div className='request-form__block'>
                        <div className='request-form__block-title'>Если представленные решения не соответствуют Вашей задаче, опишите ее в поле ниже</div>
                        <div className='request-form__input-container'>
                                <label htmlFor=""></label>
                                <input className="request-form__input" type="text" id="комментарий" name="комментарий" value={formData.комментарий} onChange={handleChange} placeholder="Опишите задачу"/>
                        </div>
                        <div className='request-form__inputs'>
                            <div className='request-form__input-container'>
                                <label htmlFor=""></label>
