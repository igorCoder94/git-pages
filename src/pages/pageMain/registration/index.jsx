...
const Registration = () => {
    return <section className='registration__section'>
        <div className='registration__container container'>
            ...
            <div className='registration__border registration__border-left'></div>
            <div className='registration__border registration__border-left-center'></div>
            <div className='registration__border registration__border-right-center'></div>
            <div className='registration__border registration__border-right'></div>
        </div>
    </section>
}
