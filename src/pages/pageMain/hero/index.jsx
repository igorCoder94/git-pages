      ...
      <div className="hero__container container">
            ...
            <div className="hero__top">
              <div className="hero__left">
                <h1 className="hero__title">
                  <span className="hero__know">
                    Знайте
                    <br />
                    свои
                    <br />
                  </span>
                  <span className="hero__scada">SCADA</span>
                </h1>
                <div className="hero__description">
                  Быстрое принятие решений и упрощенный контроль исполнения за
                  счет комплексного мониторинга и диспетчеризации
                  производственных систем управления.
                </div>
                <div className="hero__buttons">
                  <a className="hero__button hero__button-blue" href="/">
                    Пробная версия {">"}
                  </a>
                  <a
              ...
              <div className="hero__left">
                ...
                <div className="hero__icons">
                  <div className="hero__icons-inner">
                    <img className="hero__icon" src={dimIcon} alt="ДиМ" />
                    <span>ДиМ</span>
                  </div>
                  <div className="hero__icons-inner">
                    <img className="hero__icon" src={toirIcon} alt="ТОиР" />
                    <span>ТОиР</span>
                  </div>
                </div>
                <div className="hero__description">
                  Диспетчеризация и мониторинг работы устройств. Контроль
                  плановых и внештатных работ сотрудников службы эксплуатации и
                  обслуживания фасада. Единый электронный документооборот.
                </div>
                <div className="hero__buttons">
                  <a className="hero__button hero__button-blue" href="/">
                    Пробная версия {">"}
            ...
            <div className="hero__top">
              <div className="hero__left">
                ...
                <div className="hero__icons">
                  ...
                  <div className="hero__icons-inner">
                    <img className="hero__icon" src={mapIcon} alt="BIM" />
                    <span className="hero__bim">BIM модели</span>
                  </div>
                </div>
                <div className="hero__description">
                  Диспетчеризация работы устройств административных зданий.
                  Интерактивные карты с отображением камер и датчиков.
                  Подключенный модуль интеграции BIM моделей зданий.
                </div>
                <div className="hero__buttons">
                  <a className="hero__button hero__button-blue" href="/">
                    Пробная версия {">"}
            ...
            <div className="hero__top">
              <div className="hero__left">
                ...
                <div className="hero__icons">
                  ...
                  <div className="hero__icons-inner">
                    <img className="hero__icon" src={settingsIcon} alt="ТОиР" />
                    <span>Гибкие Бизнес Процессы</span>
                  </div>
                </div>
                <div className="hero__description">
                  Диспетчеризация и мониторинг работы устройств жилых зданий,
                  информирование жильцов, контроль работ обслуживающего
                  персонала.
                </div>
                <div className="hero__buttons">
                  <a className="hero__button hero__button-blue" href="/">
          ...
          <SwiperSlide>
            <div className="hero__top">
              <div className="hero__left">
                ...
                <div className="hero__description">
                  Объединение нескольких SCADA-систем предприятия в едином
                  сервисе для более точного анализа работы оборудования.
                  Контроль работ внутреннего или внешнего сервиса.
                </div>
                <div className="hero__buttons">
                  <a className="hero__button hero__button-blue" href="/">
                    Пробная версия {">"}
        ...
        {!isTablet ? (
          <div className="hero__info">
            <h3 className="hero__info-title">
              Отечественная Wonderware System Platform
            </h3>
            <div className="hero__info-description">
              Сервис UNIOS является отечественным решением диспетчеризации и
              мониторинга оборудования на промышленных объектах в России.
            </div>
            <div className="hero__info-description-bottom">
              На данный момент UNIOS проходит регистрацию ЕРПОР для сертификации
              и занесения в Единый реестр Программного Обеспечения России.
            </div>
          ...
          <div className="hero__info-mobile">
            ...
            <h3 className="hero__info-title-mobile">
              Отечественная
              <br />
